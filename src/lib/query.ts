...
export const queryKeys = {
  ...
  // Whether Collection draws `Refine rankings ›` (T5): the server's status for one
  // category, read with a limit of one. Per account, because it is about their evidence.
