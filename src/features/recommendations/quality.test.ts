...
candidate, against an architecture that budgets six per slate.

It groups a subtitled entry (\`Spider-Man: No Way Home\`) and a *named* sequel marker
(\`The Godfather Part II\`, \`It Chapter Two\`). It never reads a bare number as a marker,
