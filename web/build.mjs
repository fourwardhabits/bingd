...
/**
 * `mode` is a **pre-flight gate and no longer an output switch** (2026-09-10).
 *
...
#
# GENERATED BY web/build.mjs — edit that, not this. It is built rather than committed
# so the robots directives below stay in one place with the pages' own meta tags; they
# no longer follow distribution.config.json's \`mode\`, which changes nothing here.
