...
**Written 2026-08-29 against `54e32fd`; reconciled 2026-08-30 against `95fd4d7`, and again the same day against `2f27577`.** The operational companion to
...
same shape nonprod reports today (`tmdb-adapter` **v7** since 2026-08-30, `push-sender` v3).
