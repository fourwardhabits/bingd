...
| **Production client source** | `integration/letterboxd-main`, code gated at **`126493b`** (later commits on the branch are docs only) (§F): current main plus the Letterboxd branches, nothing preview-only |
