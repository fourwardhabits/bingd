...
//
// Both moved to `profile-reviews.test.mjs` on 2026-08-17. `update_profile` and
// `change_username` were replaced by one `save_profile`, because a screen with two
// saves can leave the name written and the handle refused — and the tests moved with
// the function rather than being left here to fail against a signature that no longer
// exists. What stays in this file is what 20260817000600 still owns: privacy, the
// inbox, and deletion.
// ---------------------------------------------------------------------------
